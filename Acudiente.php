...
<body>
	...
	<div class="gallery">
		...
		<div class="panel panel-default">
		  <div class="panel-heading"><h5 class="main-w3l-title"><center>Registrar Acudientes</center></h5></div>
		  	<div class="panel-body">
    			<div class="container">	


					<form id="FrmEstudiantes" action="Procesa/P_acudiente.php?metodo=save" method="post" style="background-color: #f5f5f5;padding: 5px; margin:20px">
    ...
    {     
            $.ajax({
              type : "POST",
              url : "Procesa/P_acudiente.php?metodo=listar",
              data : { 
                                                        
              },
              success : function( data ){
              $('#t_acudiente').html(data);
