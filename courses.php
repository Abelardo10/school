	...
	<div class="courses">
		<div class="container">
			...
			<div class="col-md-4 courses-info">
				...
				<p class="batch">Batch Starts from <span>1 Feb 2018</span></p>
			</div>
			<div class="col-md-4 courses-info">
				<h5>.NET Programming</h5>
				<div class="c-image">
			...
			<div class="col-md-4 courses-info">
				...
				<p class="paragraph-agileinfo">Proin iaculis purus consequat sem cure digni ssim. Donec porttitora entum suscipit aenean rhoncus posuere odio in tincidunt.</p>
				<p class="batch">Batch Starts from <span>1 Mar 2018</span></p>
			</div>
			<div class="col-md-4 courses-info">
				<h5>Logo/Icons Designing</h5>
				<div class="c-image">
					<img src="images/t2.jpg" alt=" " class="img-responsive">
					<h6>Trainer Name</h6>
					<div class="clearfix"></div>
