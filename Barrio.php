							...
							<div class="form-group">
								<div class="row"><!--primera fila-->   							 
									<div class="col-md-6 container">								
										<input type="hidden" name="TxtId" id="TxtId" class="form-control" placeholder="IdBarrio" enable="false">
									
										<div class="col-md-12">
										<div class="form-group" style="margin-top: 2em">
											<input type="text" name="TxtBarrio" id="TxtBarrio" class="form-control" placeholder="Barrio" required="Campo Requerido">
										</div>
...
<div class="col-md-3"></div>
		...
		<div class="col-md-12">	
			<div class="panel panel-default">
			  <div class="panel-heading"><h2 class="main-w3l-title"><center>Registros de Barrios</center></h2></div>
			  	<div class="panel-body">
	    			<div class="container">	
 ...
 <div class="row">
    ...
    function editar(dato){
      $("#TxtId").val(dato.Barrio_id);            
      $("#TxtBarrio").val(dato.barrio);     
    ...
    {     
            $.ajax({
              type : "POST",
              url : "Procesa/P_barrio.php?metodo=listar",
              data : { 
    ...
    {          
    	var id = $("#TxtId").val();
    	    ...
    	    $.ajax({
              ...
              type : "POST",
              url : "Procesa/P_barrio.php?metodo=eliminar",
              data : { id
